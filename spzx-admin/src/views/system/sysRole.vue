<template>
    <div class="search-div">
        ...
        <el-table :data="list" style="width: 100%">
            ...
            <el-table-column label="操作" alig="center" width="280" #default="scope">
...
import { GetSysRoleListByPage, ResetSearch, SaveSysRole, UpdateSysRole, DeleteSysRoleById } from '@/api/sysRole'
...
const resetData = async () => {
    const { data, code, message } = await ResetSearch(pageParams.value.page, pageParams.value.limit)
